...
syn keyword tyKeyword with do let pub function generator match while for if else try catch finally throw return in not and or yield break continue macro operator static
